...
public class MoSAMLTemplateManager {
    ...
    public HttpResponse showTestConfigurationResult(MoSAMLResponse samlResponse, HttpServletRequest request,
                                                    HttpServletResponse response) throws IOException, MoSAMLException {
